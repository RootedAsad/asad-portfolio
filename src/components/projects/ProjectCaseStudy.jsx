          ...
          <div className="grid min-h-[720px] lg:grid-cols-[46%_54%]">
            ...
            >
              ...
              >
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6" style={{ color: "var(--color-muted)" }}>
                  {project.description}
                </p>
            ...
            <div className="max-h-[88vh] overflow-y-auto">
              <div className="p-7 sm:p-9 lg:p-11">
                ...
                <div
                  ...
                  style={{ color: "var(--color-muted)" }}
                >
                  <span style={{ color: "var(--color-text)" }}>Muhammad Asad</span>
                    ...
                    <div className="space-y-3">
                      {project.features.map((feature) => (
                        ...
                        >
                          ...
                          <span className="text-sm leading-6" style={{ color: "var(--color-muted)" }}>
                            {feature}
                          </span>
                        </div>
                      ))}
